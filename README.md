...
<center>File share App</center>
</h1>
<hr>
<!-- Description -->
<h4 align="center">Simple file server using react and firebase</h4>
...
![image](https://github.com/qobulovasror/file-share/assets/71517683/34f5a4e1-4d6d-4e26-8c94-812ae94cbf6f)
  ...
  - Upload file
  - Download file
  - Download via code for security
...
- **firebase**
  ...
  ```bash
  git clone https://github.com/qobulovasror/file-share.git
  ``` 
